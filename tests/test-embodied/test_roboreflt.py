...
JSONL_FILE_PATH = "./data/roboreflt/final_dataset/testA/roborefit_testA.json"
...
def main():
    ...
    for item in data:
        ...
        task = (
            f'{task}\n'
            'Your answer should be formatted as a tuple, i.e. [x, y], where each tuple contains the x and y coordinates of several points satisfying the conditions above. Coordinates are absolute coordinates(a center point defined by top-left and bottom-right coordinates).\n'
        ...
        image = os.path.join("./data/roboreflt/",item.get("rgb_path"))
