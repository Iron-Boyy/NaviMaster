...
if __name__ == '__main__':
    ...
    parser.add_argument("--answer_file", default="/mnt/shared-storage-user/luozhihao/codebase/code/RoboPoint/result/navimaster_guiodyssey_10000_embodied3_gui7_117_roboreflt.jsonl")
    parser.add_argument("--data_dir", default="/mnt/shared-storage-user/luozhihao/codebase/dataset/roboreflt")
    parser.add_argument("--question_file", default="/mnt/shared-storage-user/luozhihao/codebase/dataset/roboreflt/final_dataset/testA/roborefit_testA.json")
    ...
    for idx, question in enumerate(tqdm(questions[:args.num_questions])):
        ...
        mask = np.array(Image.open(f"{args.data_dir}/{question['mask_path']}").convert('L')) / 255.
        ...
        accuracy.append(acc)
    print(f"Robotrflt Accuracy: {np.mean(accuracy)}")
