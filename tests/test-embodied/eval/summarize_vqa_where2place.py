...
if __name__ == '__main__':
    ...
    parser.add_argument("--answer_file", default="/mnt/shared-storage-user/luozhihao/codebase/code/RoboPoint/result/navimaster_guiodyssey_7000+7000_embodied_81.jsonl")
    parser.add_argument("--data_dir", default="/mnt/shared-storage-user/luozhihao/codebase/dataset/where2place")
    ...
    for idx, question in enumerate(questions[:args.num_questions]):
        ...
        accuracy.append(acc)
    print(f"Where2Place Accuracy: {np.mean(accuracy)}")
