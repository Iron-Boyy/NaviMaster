...
from ...utils.reward_score import math_compute_score, r1v_compute_score, r1gui_compute_score, agent_compute_score
...
class CustomRewardManager:
    def __init__(self, tokenizer: PreTrainedTokenizer, compute_score: str):
        ...
        elif compute_score == "agent":
            self.compute_score: Callable[[str, str], RewardScore] = agent_compute_score
        else:
